export const surpriseMePrompts = [
  ...
  " a colorful abstract pattern using circles and squares of different sizes and colors.",
  "a vibrant landscape with a bright sun, green trees, blue sky, and a sparkling river.",
  " an imaginary creature with bright and bold colors, inspired by the tropical rainforest.",
  "a surreal scene with floating islands, rainbow-colored clouds, and a hot air balloon.",
  " a futuristic cityscape with neon lights, flying cars, and towering skyscrapers in bold colors.",
  "a playful scene with cute animals, colorful flowers, and a rainbow in the background.",
  " a psychedelic pattern with swirling shapes and vibrant colors inspired by the 1960s.",
  "a magical forest scene with a unicorn, colorful mushrooms, and a shimmering waterfall.",
